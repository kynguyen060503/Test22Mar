...
router.post('/', check_authorization ,check_authentication(constants.MOD_PERMISSION), async function(req, res, next) {
  try {
    let body = req.body
...
router.put('/:id', check_authorization ,check_authentication(constants.MOD_PERMISSION), async function(req, res, next) {
